    ...
    return (
      <div className="flex items-center justify-between border-b p-2">
        ...
        <div className="flex items-center gap-2">
          {/** biome-ignore lint/a11y/noLabelWithoutControl: switch is the input */}
          <label className="-my-0.5 flex items-center gap-2 rounded-md bg-accent px-2 py-1.5">
            <p className="font-medium text-sm">Edit with Script</p>
            <Switch />
          </label>
