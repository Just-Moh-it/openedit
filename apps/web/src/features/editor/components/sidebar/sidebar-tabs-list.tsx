...
export const SidebarTabsList = observer(function SidebarTabsList() {
  ...
  return (
    <aside className="flex min-h-0 w-18 flex-col items-stretch justify-between border-r py-3">
      <TabsPrimitive.TabsList className="flex flex-col items-center gap-3">
